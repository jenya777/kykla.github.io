$(function(){ 
    ...
    $('<div id="overlay-popup-m1"></div><div id="m1-form" class="m1modal"><a class="close-m1"></a><div><div class="popup-m1-title">Вам понравилось это предложение?</div><div class="popup-m1-cont"><div class="popup-m1-text1">Мы расскажем Вам все об этом товаре, предложим наилучшие условия и ознакомим с подходящими акционными предложениями!</div><form  method="POST" action="contact_form/contact_process.php" class="popup-m1-form"><input type="text" name="name" placeholder="Введите ваше имя" required=""><input type="text" name="phone" placeholder="Введите телефон" required=""><<button  onclick="yaCounter‎46657029.reachGoal(order.lol.sp'); return true;">Перезвоните мне</<button  onclick="yaCounter‎46657029.reachGoal(order.lol.sp'); return true;"><input type="hidden" name="is_popup" value="1" /><input type="hidden" name="from_recall_<button  onclick="yaCounter‎46657029.reachGoal(order.lol.sp'); return true;"" value="0" /></form><div class="popup-m1-text2">Оператор перезвонит Вам через 5-10 минут</div></div></div></div>').insertAfter("body");
